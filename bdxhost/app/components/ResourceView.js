      ...
      readFile(path, (err, data) => {
        ...
        if (this.props.fileType === "PAC") {
          ...
          const meshes = js.meshes.map(mesh => {
            ...
            geom.setIndex(faces);
            geom.addAttribute('position', new THREE.Float32BufferAttribute(vert, 3));
            geom.addAttribute('normal', new THREE.Float32BufferAttribute(normal, 3));
            ...
            const mat = new THREE.MeshPhongMaterial({
              ...
              normalMap: mesh.normTexturePath && Renderer.load(mesh.normTexturePath),
              specularMap: mesh.specTexturePath && Renderer.load(mesh.specTexturePath),
              transparent: true,
              alphaTest: 0.05
            });
